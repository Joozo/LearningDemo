$(document).ready(function () {
    $("#coverFileUploader").uploadify({
        ...
        "buttonText": "选择商品图片",
        "uploader": ImageInfo.ImageServer + "/UploadHandler.ashx?appName=product&watermarkPic=" + ImageInfo.LogoUrl,
        "auto": false,
        ...
        "onUploadSuccess": function (file, data, response) {
            ...
            if (data.state != "SUCCESS") {
                ...
                //var img = new Image();
                //img.src = ImageInfo.ImageServer + ImageInfo.LogoUrl;
                //if (img.complete) { //存在于缓存
                //    if (img.height <= 1500 && img.width <= 900 && img.width >= 750) {
                //        ImageInfo.SaveImageInfo(data.url);
                //    } else {
                //        $.alert("请上传合适尺寸的图片", function () {
